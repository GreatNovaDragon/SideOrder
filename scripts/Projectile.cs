...
public partial class Projectile : Area2D
{
	...
	[Export]
	public Godot.Collections.Array<Texture2D> Splats { get; set; }
	int Frame;
	Map Map;
	double Velo = 0.0f;
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		{
			Map.Paint(SplatTexture, new Vector2I((int)GlobalPosition.X, (int)GlobalPosition.Y), Color, (float)SizeScale);
			QueueFree();
		}
